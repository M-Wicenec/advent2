"""
advent2 component module.

This is the module of advent2 containing DALiuGE data components.
...
# @param[in] param/appclass Drop Class/advent2.MyData/String/readonly/
