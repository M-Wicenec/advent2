"""
advent2 appComponent module.

This is the module of advent2 containing DALiuGE application components.
...
# @param[in] param/appclass Application Class/advent2.MyApp/String/readonly/
